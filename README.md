...
## 데이터 전처리
<p align='center'><img src="assets/fig00.png" width="200"><img src="assets/fig02.png" width="380"></p>

**input**: 전일오후6시-오전9시 119신고접수량 

집계시간은 인풋데이터를 보듯이 집계시점으로 6시간전을 시작으로 6시간 단위로 접수량을 집계, 그리고 기존데이터가 데이트타입이 아닌 문자열데이터로 되어있어 데이터전처리가 불가피했습니다.

<p align='center'><img src="assets/fig03.png" width="640"><img src="assets/fig04.png" width="180"></p>

그러므로 전처리 후 시간대별 접수량집계데이터 생성했습니다.
...
<center> 시간대별 접수량의 분포표 </center>

<br>

<p align='center'><img src="assets/fig06.png" width="640"></p>
<center> 13년도부터 22년도까지의 119신고접수량 시계열그래프 </center>
<br>
...
class LSTM(nn.Module):
    ...
    def forward(self, x):
        ...
        return x
```
train 데이터에 대하여 7:3의 비율료 vaild 를 설정하고 훈련.
...
학습된 결과값을 시각화 해본결과 일관된 주기성은 예측가능하나, 이상치에 대한 예측이 안되는 것으로 확인했습니다. 해당 날이 공휴일인지 아닌지에 따른 값들이 예측하는데 도움이 될 수도 있다는 판단도 있었으나, 이상치에 대한 진폭 큰 데이터가 해마다 일정한 공휴일에 해당되지 않다는 판단도 있어습니다. 
...
<p align='center'><img src="assets/fig04.png" width="180"> 👉 <img src="assets/fig10.png" width="380"></p>
